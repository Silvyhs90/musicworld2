...
<header class="encabezado">
   ...
   <h1 class="centrado text-light">Parcial 2 - Produccion Web 2 </h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="GET" action="/tp2/saucedo/php/controllers/buscador.controller.php">
                    <div class="form-group">
                        <input type="text" class="form-control" name="cancion" value="" placeholder="Buscar...">
                    </div>
                    <br>
                    <div class="form-group">
